...
class Rcpy extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('rcpy')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('rcpy')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('rcpy')->where('id', $id)->find();
            if (!$vo) {
