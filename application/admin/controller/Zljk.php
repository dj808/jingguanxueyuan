...
class Zljk extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('zljk')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('zljk')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('zljk')->where('id', $id)->find();
            if (!$vo) {
