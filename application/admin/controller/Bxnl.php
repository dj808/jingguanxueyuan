...
class Bxnl extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('bxnl')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('bxnl')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('bxnl')->where('id', $id)->find();
            if (!$vo) {
