...
class Zysz extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('zysz')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('zysz')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('zysz')->where('id', $id)->find();
            if (!$vo) {
