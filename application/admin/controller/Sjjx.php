...
class Sjjx extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('sjjx')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('sjjx')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('sjjx')->where('id', $id)->find();
            if (!$vo) {
