...
class Pyms extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('pyms')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('pyms')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('pyms')->where('id', $id)->find();
            if (!$vo) {
