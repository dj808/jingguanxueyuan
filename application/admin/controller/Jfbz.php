...
class Jfbz extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('jfbz')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('jfbz')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('jfbz')->where('id', $id)->find();
            if (!$vo) {
