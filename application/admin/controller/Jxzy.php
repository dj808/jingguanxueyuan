...
class Jxzy extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('jxzy')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('jxzy')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('jxzy')->where('id', $id)->find();
            if (!$vo) {
