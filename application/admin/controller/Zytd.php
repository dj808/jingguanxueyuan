...
class Zytd extends Controller
{
    ...
    /* public  function index(){
        $list= Db::name('zytd')->where('isdelete',0)->select();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('zytd')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('zytd')->where('id', $id)->find();
            if (!$vo) {
