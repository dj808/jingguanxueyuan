...
class Cgzs extends Controller
{
    ...
    /* public  function index(){
        $list= Db::name('cgzs')->where('isdelete',0)->select();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('cgzs')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('cgzs')->where('id', $id)->find();
            if (!$vo) {
