...
class Kcsj extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('kcsj')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('kcsj')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('kcsj')->where('id', $id)->find();
            if (!$vo) {
