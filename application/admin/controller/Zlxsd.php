...
class Zlxsd extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('zlxsd')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('zlxsd')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('zlxsd')->where('id', $id)->find();
            if (!$vo) {
