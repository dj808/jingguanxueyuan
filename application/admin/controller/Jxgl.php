...
class Jxgl extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('jxgl')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('jxgl')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('jxgl')->where('id', $id)->find();
            if (!$vo) {
