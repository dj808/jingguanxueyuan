...
class Zyjse extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('zyjse')->find();
    ...
    public function add(){
        ...
        if($this->request->isPost()){
            ...
            return  $this->view->fetch('admin/zyjse/index');
        }
    }
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('zyjse')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('zyjse')->where('id', $id)->find();
            if (!$vo) {
