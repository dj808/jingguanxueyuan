...
class Zyjs extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('zyjs')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('zyjs')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('zyjs')->where('id', $id)->find();
            if (!$vo) {
