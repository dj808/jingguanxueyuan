...
class Jgky extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('jgky')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('jgky')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('jgky')->where('id', $id)->find();
            if (!$vo) {
