...
class Zyys extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('zyys')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('zyys')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('zyys')->where('id', $id)->find();
            if (!$vo) {
