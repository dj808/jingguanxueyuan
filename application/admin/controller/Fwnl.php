...
class Fwnl extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('fwnl')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('fwnl')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('fwnl')->where('id', $id)->find();
            if (!$vo) {
