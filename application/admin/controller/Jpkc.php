...
class Jpkc extends Controller
{
    ...
    /* public  function index(){
        $list= Db::name('jpkc')->where('isdelete',0)->select();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('jpkc')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('jpkc')->where('id', $id)->find();
            if (!$vo) {
