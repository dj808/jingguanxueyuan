...
class Dwjg extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('dwjg')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('dwjg')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('dwjg')->where('id', $id)->find();
            if (!$vo) {
