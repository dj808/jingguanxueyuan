...
class Xszl extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('xszl')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('xszl')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('xszl')->where('id', $id)->find();
            if (!$vo) {
