...
class Kcss extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('kcss')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('kcss')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('kcss')->where('id', $id)->find();
            if (!$vo) {
