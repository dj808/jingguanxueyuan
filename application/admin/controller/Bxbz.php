...
class Bxbz extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('bxbz')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('bxbz')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('bxbz')->where('id', $id)->find();
            if (!$vo) {
