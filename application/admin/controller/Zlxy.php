...
class Zlxy extends Controller
{
    /**
     * 关于我们显示
     */
    public  function index(){
        $list= Db::name('zlxy')->find();
    ...
    public function edit(){
        ...
        if ($this->request->isAjax()) {
            ...
            $goods = Db::name('zlxy')->where('id', $id)->update($data);
            if ($goods) {
            ...
            $vo =  Db::name('zlxy')->where('id', $id)->find();
            if (!$vo) {
